...
public class CrawlerController {
    ...
    @PostMapping
    public ResponseEntity<String> startCrawling(@RequestBody CrawlerRequest crawlerRequest) throws InterruptedException, IOException {
        crawlerService.start(
                crawlerRequest.getSeeds(),
                crawlerRequest.getNumOfThreads(),
                crawlerRequest.getMaxNumOfPages());
        return new ResponseEntity<>("Crawling has started successfully", HttpStatusCode.valueOf(200));
    }
